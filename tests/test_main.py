...
def test_swm_invalid_signature() -> None:
    """
    When a SNS webhook message is received with an invalid signature
    I should not be able to validate the message.
    """
    message = {
        "Type": "Notification",
    ...
    with pytest.raises(Exception):
        SNSWebhookMessage.model_validate(message)
